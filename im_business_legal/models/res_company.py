...
class Classification(models.Model):
    ...
    section_id = fields.Many2one('im.legal.classification.section',
                                 related="group_id.division_id.section_id", store=True)
...
class Company(models.Model):
    ...
    classification_ids = fields.Many2many(
        'im.legal.classification', relation='im_legal_classifiacation_rel', string='Classification', required=True)
    ...
    franchise_model_id = fields.Many2one('im.legal.franchise.model')
    franchise_operation_model_id = fields.Many2one('im.legal.franchise.operation.model')
